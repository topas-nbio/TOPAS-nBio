...
void TsVIRTProcedure::contactReactions(G4int i,std::unordered_map<G4int, G4bool> used) {
...
void TsVIRTProcedure::ConductReactions() {
...
void TsVIRTProcedure::CleanIRTVariables() {
	fIRTIndex.clear();
	fIRTValues.clear();
	fIRTMolA.clear();
	fIRTMolB.clear();
...
void TsVIRTProcedure::RemoveMolecule(G4int Index) {
...
std::vector<G4int> TsVIRTProcedure::GetSurvivingMolecules() {
