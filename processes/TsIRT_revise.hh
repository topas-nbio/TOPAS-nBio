#ifndef TsIRT_revise_hh
#define TsIRT_revise_hh
...
class TsIRT_revise: public TsVIRTProcedure {
public:
	TsIRT_revise(TsParameterManager*, G4String);
	~TsIRT_revise();
	...
	TsIRTConfiguration_revise::TsMolecule ConstructMolecule(G4Track*, G4double, G4int, G4ThreeVector);
...
//	std::vector<TsIRTConfiguration_revise::TsMolecule> fChemicalSpecies;
	std::unordered_map<G4int,TsIRTConfiguration_revise::TsMolecule> fChemicalSpecies;
