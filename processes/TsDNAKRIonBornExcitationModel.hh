...
#ifndef TsDNAKRIonBornExcitationModel_h
#define TsDNAKRIonBornExcitationModel_h 1
...
class TsDNAKRIonBornExcitationModel: public G4VEmModel
{
public:
  TsDNAKRIonBornExcitationModel(const G4ParticleDefinition* p = 0,const G4String& nam = "DNAKRIonBornExcitationModel");

  virtual ~TsDNAKRIonBornExcitationModel();
...
private:
  ...
  //
  TsDNAKRIonBornExcitationModel & operator=(const  TsDNAKRIonBornExcitationModel &right);
  TsDNAKRIonBornExcitationModel(const  TsDNAKRIonBornExcitationModel&);
};

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

inline void TsDNAKRIonBornExcitationModel::SelectStationary (G4bool input)
{ 
    statCode = input; 
}		 
