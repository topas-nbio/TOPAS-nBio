#ifndef TsIRTConfiguration_revise_hh
#define TsIRTConfiguration_revise_hh
...
class TsIRTConfiguration_revise {
public:
	TsIRTConfiguration_revise(G4String, TsParameterManager*);
	~TsIRTConfiguration_revise();
...
public:
	...
	std::map<G4int, TsIRTConfiguration_revise::TsMolecularReaction> GetReactions() {return fReactions;}
