...
#ifndef TsDNAKondoRamosLiChargeDecrease_h
#define TsDNAKondoRamosLiChargeDecrease_h 1
...
class TsDNAKondoRamosLiChargeDecrease : public G4VEmModel
{

public:

  TsDNAKondoRamosLiChargeDecrease(const G4ParticleDefinition* p = 0, 
		          const G4String& nam = "DNAKRChargeDecreaseModel");

  ~TsDNAKondoRamosLiChargeDecrease() override = default;
...
private:
  ...
  TsDNAKondoRamosLiChargeDecrease & operator=(const  TsDNAKondoRamosLiChargeDecrease &right);
  TsDNAKondoRamosLiChargeDecrease(const  TsDNAKondoRamosLiChargeDecrease&);

  // Reusable particle definitions
  G4ParticleDefinition* lithium3pDef = nullptr;
  G4ParticleDefinition* lithium2pDef = nullptr;
  G4ParticleDefinition* lithium1pDef = nullptr;
  G4ParticleDefinition* lithium0pDef = nullptr;

  std::map<const G4ParticleDefinition*,std::vector<std::vector<G4double>>> CrossSections;
  std::map<const G4ParticleDefinition*,G4double> IonIonizationEnergy;
  std::map<G4int,G4double> WaterBindingEnergy;

};

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

inline void TsDNAKondoRamosLiChargeDecrease::SelectStationary (G4bool input)
{ 
    statCode = input; 
}		 
