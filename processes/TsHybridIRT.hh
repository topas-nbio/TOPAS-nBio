...
public:
	...
	void SetDeltaGValues(std::map<G4int, std::map<G4double, G4int>> dgval) {fDeltaGValues = dgval;}
	...
	std::vector<G4int> GetSurvivingMolecules(G4int i = -1);
...
private:
	...
	G4bool DoGillespieDirect(G4double);
