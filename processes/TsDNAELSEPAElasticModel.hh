...
#ifndef TsDNAELSEPAElasticModel_h
#define TsDNAELSEPAElasticModel_h 1
...
class TsDNAELSEPAElasticModel : public G4VEmModel
{

public:

  TsDNAELSEPAElasticModel(const G4ParticleDefinition* particle = nullptr,
                          const G4String& nam = "DNAELSEPAElasticModel");

  ~TsDNAELSEPAElasticModel() override;

  TsDNAELSEPAElasticModel & operator=(const TsDNAELSEPAElasticModel &right) = delete;
  TsDNAELSEPAElasticModel(const TsDNAELSEPAElasticModel&) = delete;
