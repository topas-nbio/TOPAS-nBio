...
DrDSBMoleculeManager::DrDSBMoleculeManager() {
    fBeakMoleculeIndex = DrDefinitions::Instance()->GetBreakMoleculeIndex();
}
DrDSBMoleculeManager::~DrDSBMoleculeManager() {}
...
DrBreakMolecule* DrDSBMoleculeManager::LinkNewBreakMolecule(G4Track* track){
    ...
    track->SetAuxiliaryTrackInformation(fBeakMoleculeIndex,breakMolecule);
...
void DrDSBMoleculeManager::LinkThisBreakMolecule (G4Track* track, DrBreakMolecule* breakMolecule){
    ...
    track->SetAuxiliaryTrackInformation(fBeakMoleculeIndex,newBreakMolecule);
}


void DrDSBMoleculeManager::LinkThisBreakMolecule(const G4Track& trackOld, const G4Track& trackNew){
    DrBreakMolecule* breakMolecule = (DrBreakMolecule*)trackOld.GetAuxiliaryTrackInformation(fBeakMoleculeIndex);
    trackOld.SetAuxiliaryTrackInformation(fBeakMoleculeIndex,nullptr);
    trackNew.SetAuxiliaryTrackInformation(fBeakMoleculeIndex,breakMolecule);
}
...
void DrDSBMoleculeManager::JoinBreakMolecule(const G4Track& trackReactant1, const G4Track& trackReactant2, G4Track* trackProduct){
    ...
    DrBreakMolecule* break1 = (DrBreakMolecule*)(trackReactant1.GetAuxiliaryTrackInformation(fBeakMoleculeIndex));
    DrBreakMolecule* break2 = (DrBreakMolecule*)(trackReactant2.GetAuxiliaryTrackInformation(fBeakMoleculeIndex));
...
void DrDSBMoleculeManager::SplitBreakMolecule(const G4Track& trackMother, G4Track* trackDaughter1, G4Track* trackDaughter2){
    ...
    DrBreakMolecule* mother = (DrBreakMolecule*)(trackMother.GetAuxiliaryTrackInformation(fBeakMoleculeIndex));
