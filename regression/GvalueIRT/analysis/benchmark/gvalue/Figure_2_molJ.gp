...
set output "images/Figure_2_molJ.eps"
...
set ylabel "G(^{\267}OH) (10^{-7}mol/J)" offset 2.0
f=1e-1/0.1036
set yrange[2:5.2]
set key bottom left 
tcut=0 
...
plot "<echo 7.0 4.9 0.2" u 1:($2*1):($3*1) w errorbars ls 2 notitle,\
     "<echo 10.0 4.8 0.12" u 1:($2*1):($3*1) w errorbars ls 2 notitle,\
     "<echo 296276, 2.72, 0.14" u 1:($2/f):($3/f) w errorbar ls 3 notitle "LaVerne 2000",\
     "<echo 493692, 2.47, 0.12" u 1:($2/f):($3/f) w errorbar ls 3 notitle,\
     "<echo 605751, 2.44, 0.12" u 1:($2/f):($3/f) w errorbar ls 3 notitle,\
     "<echo 1e6,    2.49, 0.12" u 1:($2/f):($3/f) w errorbar ls 3 notitle,\
     "<echo 1e6,    2.49, 0.12" u 1:($2/f) w p ls 3 notitle "LaVerne 2000",\
     "hydroxyl_long.csv" u 1:($1>tcut ? $2/f : 1/0) w l ls 4 lc rgb "gray50" notitle,\
     "hydroxyl_short.csv" u 1:($1>tcut ? $2/f : 1/0) w l ls 4 notitle,\
     sprintf("%sgvalue-pure-water.phsp","./") u 3:(strcol(4) eq "OH^0" ? $1/f : 1/0) w l ls 11 notitle,\
...
set ylabel "G(e^@{/Symbol \055}_{aq}) (10^{-7}mol/J)"
set ytics 0.4
set yrange[2.4:4.7]
#set key at 0.5,2.45
tcut=1.8e1

plot "<echo 7.0, 4.4, 0.2" u 1:($2*1):($3*1) w errorbars ls 4 notitle,\
     "<echo 7.0, 4.4, 0.2" u 1:($2*1) w p ls 4 notitle "Wang 2018",\
     "<echo 20.0, 4.2, 0.2" u 1:($2*1):($3*1) w errorbars ls 4 notitle,\
     "<echo 70.0e3  2.93 0.2" u 1:($2/f):($3/f)  w errorbars ls 5 notitle "Shirashi 1988",\
     "<echo 70.0e3  2.93 0.2"  u 1:($2/f) w p ls 5 notitle "Shirashi 1988",\
     "<echo 300.0e3 2.67 0.15" u 1:($2/f):($3/f)w errorbars ls 5 notitle,\
     "<echo 1e5,    2.7" u 1:($2/f):($2*0.03/f) w errorbars pt 5 ps 1.3 lc 0 notitle "Bartels 2000",\
     "electron_short.csv" u 1:($1>tcut ? $2/f : 1/0) w l ls 4 notitle, "electron_long.csv" u 1:($1>tcut ? $2/f : 1/0) w l ls 4 notitle,\
     sprintf("%sgvalue-pure-water.phsp","./") u 3:(strcol(4) eq "e_aq^-1" ? $1/f : 1/0) w l ls 11 notitle "TOPAS-nBio",\
...
set ylabel "G(H_{2}) (10^{-7}mol/J)"
set key at 0.5, 0.12
plot "../MolecularHydrogen/Pastina1999.csv" index 0 using (1e12/($1*k1*$2)):(1e12/($1*k1*$2) > 5e2 ? $3/f : 1/0):($3*0.1/f) w errorbars ls 6 notitle "H2O2",\
     "../MolecularHydrogen/Pastina1999.csv" index 1 using (1e12/($1*k2*$2)):(1e12/($1*k2*$2) > 5e2 ? $3/f : 1/0):($3*0.1/f) w errorbars ls 7 notitle "Pastina1999 K2Cr2O",\
     "../MolecularHydrogen/Pastina1999.csv" index 0 using (1e12/($1*k1*$2)):(1e12/($1*k1*$2) > 5e2 ? $3/f : 1/0) w p ls 6 notitle "Pastina 1999 (H_{2}O_{2})",\
     "../MolecularHydrogen/Pastina1999.csv" index 1 using (1e12/($1*k2*$2)):(1e12/($1*k2*$2) > 5e2 ? $3/f : 1/0) w p ls 7 notitle "Pastina 1999 (K_{2}Cr_{2}O_{7})",\
     sprintf("%sgvalue-pure-water.phsp","./") u 3:(strcol(4) eq "H_2^0" ? $1/f : 1/0) w l ls 11 notitle,\
...
unset label
set tmargin 0.3
set ylabel "G(H_{2}O_{2}) (10^{-7}mol/J)"
kobs=9.7e8
set format x "10^{%L}"
set xlabel "Time (ps)"
set yrange[0:0.85]
...
plot "../HydrogenPeroxide/Hiroki2020.csv" using (1e12/($1*kobs)):(1e12/($1*kobs)>0.e2 ? $2/f : 1/0):($2*0.02/f) w errorbars ls 8 notitle "Hiroki et al., 2002",\
     "../HydrogenPeroxide/Hiroki2020.csv" using (1e12/($1*kobs)):(1e12/($1*kobs)>0.e2 ? $2/f : 1/0) w p ls 8 notitle "Hiroki 2002",\
     "tempH2O2Ritchie.csv" index 0 u (1e12/($1*kobs)):((1e12/($1*kobs)>0.e2 ? $2/f : 1/0)):($3*sqrt(histories)/f) w errorbars ls 1 notitle,\
     "tempH2O2Ritchie.csv" index 0 u (1e12/($1*kobs)):(1e12/($1*kobs)>0.e2 ? $2/f : 1/0) with     lp   ls 1 dt 3 notitle,\
     sprintf("%sgvalue-pure-water.phsp","./") u 3:(strcol(4) eq "H2O2^0" ? $1/f : 1/0) w l ls 11 notitle,\
...
plot sprintf("%sgvalue-pure-water.phsp","./") u 3:(strcol(4) eq "H^0" ? $1/f : 1/0) w l ls 11 notitle "No-spin",\
     "../HydrogenAtom/HuertaParajon.csv" index 0 u (1e12/($1*2.1e8 + 1e-3 * 1.4e6)):(($2-4.60526e-1)/f):($2*0.05/f) w errorbars ls 10 notitle,\
     "H2_minus_X_equal_to_H_noSpin.csv" index 1 u 1:(($2-MCNoSpin)/f):(sqrt($3*$3+eMCNoSpin*eMCNoSpin)/f) w errorbars ls 1 notitle,\
     "H2_minus_X_equal_to_H_noSpin.csv" index 1 u 1:(($2-MCNoSpin)/f) w lp ls 1 dt 3 notitle,\
